                    ...
                    x-init="
                        (async () => {
                            ...
                            await loadAsset('link[data-nt-employee-schedule-css]', () => {
                                ...
                                link.rel = 'stylesheet'
                                link.href = '{{ asset('css/employee-schedule-calendar.css') }}?v=20260707-mobile-month-picker-2'
                            ...
                            await loadAsset('script[data-nt-employee-schedule-js]', () => {
                                ...
                                script.src = '{{ asset('js/employee-schedule-calendar.js') }}?v=20260707-mobile-month-picker-2'
